...
export const GlowingCard: React.FC<GlowingCardProps> = ({
  ...
  return (
    <div
      {...props}
      className={cn(
        "glowing-card relative flex-1 min-w-[14rem] p-6 rounded-2xl text-white",
        hoverEffect && "glowing-card-hover",
        className
      )}
      style={{
        ...
        {enableGlow && (
          <div
            ...
            className={cn(
              ...
              "glow-overlay opacity-0 transition-opacity ease-out"
            )}
            style={{
              WebkitMask:
              ...
              {React.Children.map(children, (child, index) => {
                if (React.isValidElement(child) && child.type === GlowingCard) {
                  ...
                  return React.cloneElement(element, {
                    ...
                    style: {
                      ...element.props.style,
                      backgroundColor: `color-mix(in srgb, ${cardGlowColor} 18%, transparent)`,
                      borderColor: cardGlowColor,
                      boxShadow: `0 0 0 1px inset ${cardGlowColor}, 0 0 26px ${cardGlowColor}80`,
                    },
                  });
                }
                return child;
